import { API_ENDPOINTS, GRADING_TEXT } from '~/src/core/constants';
    ...
    while (attempt <= maxRetries) {
      try {
        if (this.provider === "gemini") {
          const url = `${API_ENDPOINTS.geminiBase}/models/${this.modelName}:generateContent?key=${this.apiKey}`;
        ...
        if (this.provider === "openai" || this.provider === "deepseek" || this.provider === "openrouter" || this.provider === "custom") {
          ...
          if (this.provider === "openai") baseUrl = API_ENDPOINTS.openAiBase;
          else if (this.provider === "deepseek") baseUrl = API_ENDPOINTS.deepSeekBase;
          else if (this.provider === "openrouter") baseUrl = API_ENDPOINTS.openRouterBase;
